                        ...
                        <form role="form" method="post" action="modelo-evento.php" name="guardar-registro" id="guardar-registro">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="categoria_evento" class="form-control seleccionar" id="form-control">
                                        <!-- Opcion por default en el SELECT: Seria, "Seleccione"-->
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="invitado_evento" class="form-control seleccionar" id="form-control">
                                        <!-- Opcion por default en el SELECT: Seria, "Seleccione"-->
                                        <option value="0">-- Seleccione --</option>
                                        <?php
                                        try {
                            ...
                            <div class="box-footer">
                                <input type="hidden" name="registro" value="actualizar-evento">
